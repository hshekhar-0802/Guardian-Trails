...
from game_level_1.scripts1.utils import load_image, load_images, Animation, display_text
from game_level_1.scripts1.entities import PhysicsEntity, Player, Animal, Skeleton
from game_level_1.scripts1.tilemap import Tilemap
from game_level_1.scripts1.clouds import Clouds
from game_level_1.scripts1.particle import Particle
...
class Game:
    def __init__(self):
        ...
        self.sounds = {
            'bgm': pygame.mixer.Sound('game_level_1/data/audios/rainforest.mp3'),
            'sword': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/attack.wav'),
            'run': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/running.mp3'),
            'jump': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/jump.mp3'),
            'death': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/death.mp3'),
            'skeleton_death': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/skeleton_death.mp3'),
            'skeleton_attack': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/skeleton_attack.mp3'),
            'defend': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/defend.mp3'),
            'heal': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/heal.mp3'),
            'hit': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/hit.mp3'),
            'skeleton_running': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/skeleton_running.mp3'),
            'player_hit': pygame.mixer.Sound('game_level_1/data/audios/not_level_specific/player_hit.mp3'),
        ...
        self.assets = {
            'level_complete':Video('game_level_1/data/level_complete_scene.mp4'),
            'level_lost': Video('game_level_1/data/level_lost_scene.mp4'),
            ...
            'animal/idle': Animation(load_images('entities/animal/rhino/idle'), img_dur=5),
            'animal/run': Animation(load_images('entities/animal/rhino/run'), img_dur=5),
        ...
        self.tilemap.load('game_level_1/data/mapnew.json')
    ...
    def draw_background_with_parallax(self):
        ...
        for x in range(-3,20):
            ...
            for img in self.assets['background']:
                ...
                self.display.blit(img, (x*bg_width - (self.scroll[0]+67.5015)*speed, 0))
    ...
    def run(self):
        ...
        while True:
            ...
            enemy_logo=pygame.image.load('game_level_1/data/images/logo/enemy.png')
            animal_logo=pygame.image.load('game_level_1/data/images/logo/animal.gif')
            heal_logo=pygame.image.load('game_level_1/data/images/logo/heal.png')
...
def escape():
    img = pygame.image.load('game_level_1/data/escape.png')
