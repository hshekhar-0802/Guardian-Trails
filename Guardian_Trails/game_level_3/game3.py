...
from game_level_3.scripts3.utils import load_image, load_images, Animation, display_text
from game_level_3.scripts3.entities import PhysicsEntity, Player, Animal, Skeleton
from game_level_3.scripts3.tilemap import Tilemap
from game_level_3.scripts3.clouds import Clouds
from game_level_3.scripts3.particle import Particle
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption('snowy_mountains')
        ...
        self.sounds = {
            'bgm': pygame.mixer.Sound('game_level_3/data/audios/rainforest.mp3'),
            'sword': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/attack.wav'),
            'run': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/running.mp3'),
            'jump': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/jump.mp3'),
            'death': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/death.mp3'),
            'skeleton_death': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/skeleton_death.mp3'),
            'skeleton_attack': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/skeleton_attack.mp3'),
            'defend': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/defend.mp3'),
            'heal': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/heal.mp3'),
            'hit': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/hit.mp3'),
            'skeleton_running': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/skeleton_running.mp3'),
            'player_hit': pygame.mixer.Sound('game_level_3/data/audios/not_level_specific/player_hit.mp3'),
        ...
        self.assets = {
            'level_complete':Video('game_level_3/data/level_complete_scene.mp4'),
            'level_lost': Video('game_level_3/data/level_lost_scene.mp4'),
            ...
            'animal/idle': Animation(load_images('entities/animal/bear/idle'), img_dur=5),
            'animal/run': Animation(load_images('entities/animal/bear/run'), img_dur=5),
        ...
        self.tilemap.load('game_level_3/data/mapnew.json')
    ...
    def run(self):
        ...
        while True:
            ...
            enemy_logo=pygame.image.load('game_level_3/data/images/logo/enemy.png')
            animal_logo=pygame.image.load('game_level_3/data/images/logo/animal.png')
            heal_logo=pygame.image.load('game_level_3/data/images/logo/heal.png')
            ...
            self.screen.blit(animal_logo,(10,10))
...
def escape():
    img = pygame.image.load('game_level_3/data/escape.png')
